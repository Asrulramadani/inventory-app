    ...
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$unit->name}}</strong></td>
                    <td>
                        <div class="dropdown">
                            ...
                            <button class="dropdown-item" wire:click.prevent="show({{$unit->id}})" data-bs-toggle="modal" data-bs-target="#modalEdit"><i class="bx bx-edit-alt me-1"></i> Edit</button>
                            <button class="dropdown-item" wire:click.="delete({{$unit->id}})"><i class="bx bx-trash me-1"></i> Delete</button>
                            </div>
                        </div>
                        </td>
...
<div>
    <div class="modal fade" id="modalEdit" tabindex="-1" style="display: none;" aria-modal="true" role="dialog" wire:ignore>
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">Edit Satuan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                <div class="modal-body">
